...
declare module PlayFabClientModule {
    export interface IPlayFabClient {
        ...
        /**
         * Attributes an install for advertisement.
        ...
        /**
         * Grants the player's current entitlements from Xbox Live, consuming all available items in Xbox and granting them to the
         ...
         * available set. In that case, the information on the game session will be returned, otherwise the Status returned will be
         * GameNotFound.
        ...
        /**
         * Submit a report for another player (due to bad behavior, etc.), so that customer service representatives for the title
...
declare module PlayFabClientModels {
    ...
    export interface AndroidDevicePushNotificationRegistrationRequest extends PlayFabModule.IPlayFabRequestCommon {
         ...
         */
        DeviceToken: string;
        /** If true, send a test push message immediately after successful registration. Defaults to false. */
    ...
    export interface SubscriptionModel {
        ...
        Expiration: string;
        /** The time the subscription was originally purchased */
