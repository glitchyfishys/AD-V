...
export function beMigration(player) {
  ...
  if (player.reality.glyphs.sac !== undefined) {
    ...
    player.reality.glyphs.sac.glitch = D(player.reality.glyphs.sac.glitch);
  }
  for (let i = 0; i < 7; i++) {
  ...
  player.requirementChecks.reality.slowestBH = D(player.requirementChecks.reality.slowestBH).neg();
