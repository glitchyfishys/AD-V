...
export const canteQuotes = {
  show: {
    ...
    lines: [
      ...
      "It does not have a name yet but the project is call Buncyn. Laugh, I'm still missing some info on that.",
  ...
  reforge: {
    id: 1,
    lines: [
      {text: 'Stop $1 Realites, we need them.', displayed: () => CanteUpgrades.all[19].isUnlocked, glitched: true, 1: ['Destroying','Destroying']},
      "I see what Glitch was talking about.",
      "Your ability to create... i should not explain that.",
