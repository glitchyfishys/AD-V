...
export const glitchRealityUpgrades = [
  ...
  },
  {
    ...
    requirement: () => `Reach ${format("1e1E14")} Antimatter with Teresa, Nameless One's Dim limit and Lai'tela active`,
    hasFailed: () => player.celestials.glitch.augment.effectbits != 265,
    checkRequirement: () => Currency.antimatter.gte("1e1E14") && Glitch.isRunning && player.celestials.glitch.augment.effectbits == 265,
