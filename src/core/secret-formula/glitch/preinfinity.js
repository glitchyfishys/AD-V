...
export const preInfinityUG = [
  ...
  },
  {
    ...
    hasFailed: () => player.dimensions.antimatter[1].amount.gt(10),
  ...
  },
  {
    ...
    hasFailed: () => player.dimensions.antimatter[3].amount.gt(20),
    checkRequirement: () => player.antimatter.e >= 25 && !player.dimensions.antimatter[3].amount.gt(20),
