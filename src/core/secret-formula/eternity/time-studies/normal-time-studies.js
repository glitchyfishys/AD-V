 ...
 *  @property {Decimal} STcost              Amount of available space theorems required to purchase if needed
...
export const normalTimeStudies = [
  ...
  },
  {
    ...
    effect: () => player.replicanti.boughtGalaxyCap.div(5).floor()
  },
  {
    id: 133,
    cost: DC.D5,
  ...
  },
  {
    ...
    effect: () => Replicanti.amount.pow(0.3).max(1),
