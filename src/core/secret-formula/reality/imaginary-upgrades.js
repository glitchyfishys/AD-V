...
export const imaginaryUpgrades = [
  ...
  },
  {
    ...
    hasFailed: () => !Ra.isRunning || player.requirementChecks.reality.slowestBH.lt(1e300),
    checkRequirement: () => Ra.isRunning && player.requirementChecks.reality.slowestBH.gte(1e300) &&
