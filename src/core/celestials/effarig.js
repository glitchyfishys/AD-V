...
export const Effarig = {
  ...
  get tickDilation() {
    return this.nerfFactor(Currency.timeShards.value).div(10).add(0.7).min(0.9999);
  },
  get multDilation() {
    return this.nerfFactor(Currency.infinityPower.value).div(4).add(0.25).min(0.9999);
  },
  get tickspeed() {
